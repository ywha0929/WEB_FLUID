...
public interface IFLUIDService extends android.os.IInterface
{
  ...
  {
    @Override public void endOfDistribute() throws android.os.RemoteException
    {
    }
  ...
  public static abstract class Stub extends android.os.Binder implements com.hmsl.fluidmanager.IFLUIDService
  {
    ...
    @Override public boolean onTransact(int code, android.os.Parcel data, android.os.Parcel reply, int flags) throws android.os.RemoteException
    {
      ...
      switch (code)
      {
        ...
        case TRANSACTION_endOfDistribute:
        {
          data.enforceInterface(descriptor);
          this.endOfDistribute();
    ...
    private static class Proxy implements com.hmsl.fluidmanager.IFLUIDService
    {
      ...
      @Override public void endOfDistribute() throws android.os.RemoteException
      {
        ...
        try {
          ...
          boolean _status = mRemote.transact(Stub.TRANSACTION_endOfDistribute, _data, _reply, 0);
          if (!_status && getDefaultImpl() != null) {
            getDefaultImpl().endOfDistribute();
            return;
          }
    ...
    static final int TRANSACTION_endOfDistribute = (android.os.IBinder.FIRST_CALL_TRANSACTION + 0);
    static final int TRANSACTION_distribute = (android.os.IBinder.FIRST_CALL_TRANSACTION + 1);
    static final int TRANSACTION_update = (android.os.IBinder.FIRST_CALL_TRANSACTION + 2);
    static final int TRANSACTION_reverseConnect = (android.os.IBinder.FIRST_CALL_TRANSACTION + 3);
  ...
  public void endOfDistribute() throws android.os.RemoteException;
